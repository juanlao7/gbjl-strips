...
\bibitem{problemdefinition} Problem definition, \url{https://moodle.urv.cat/moodle/pluginfile.php/2303642/mod_resource/content/4/PlannerExercise16-17.pdf}

\bibitem{par} PAR course \url{https://moodle.urv.cat/docnet/guia_docent/index.php?centre=17&ensenyament=1768&assignatura=17685204&font=12&any_academic=2016_17&modalitat=p}

\bibitem{strips} STRIPS paper \url{http://ai.stanford.edu/~nilsson/OnlinePubs-Nils/PublishedPapers/strips.pdf}

\bibitem{java} JAVA

\bibitem{gps} Ernst, G. and .~4ewell, A. GPS: A Case Study in Generality and Problem Solving. ACM
Monograph Series. Academic Press, New York, New York, 1969

\bibitem{notes} Notes of the PAR course
